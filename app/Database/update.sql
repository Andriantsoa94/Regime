-- ============================================================
-- MISE A JOUR DE LA BASE regime_tp - Projet NutriPlan S4
-- A executer apres database.sql et donnees.sql
-- ============================================================

USE regime_tp;

-- 1. Ajout de colonnes manquantes dans users
ALTER TABLE users
...
-- 2. Table regimes (nouvelle, differente de l'ancienne regime)
...
-- 7. Mise a jour des utilisateurs existants (ajouter prenom)
...
-- 9. Mise a jour mots de passe utilisateurs existants (user123)
...
-- 14. Codes portefeuille (15 codes)
